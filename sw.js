const CACHE='burnaverse-v2';
const CORE=['./','./index.html','./assets/styles.css','./assets/advanced.css','./assets/app.js','./assets/ui.js','./assets/advanced.js','./assets/logo.png','./assets/favicon.svg'];
