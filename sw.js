...
async function cacheFirst(req){
  ...
  const res=await fetch(req); if(res && (res.ok || res.type==='opaque')){ const copy=res.clone(); caches.open(RUNTIME).then(c=>c.put(req,copy)); } return res;
}
...
// v6: whitepaper/index.html included for online PDF export support.
